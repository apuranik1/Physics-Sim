...
public class Quaternion {
	...
	/**
	 * Converts the Quaternion to a rotation matrix so it can be applied to a Vector.
	 * Client should cache the returned matrix for repeated use
	 * @return
	 */
	public Matrix3D toMatrix() {
		...
		return new Matrix3D(n_00, n_01, n_02, n_10, n_11, n_12, n_20, n_21, n_22);
	}
}
